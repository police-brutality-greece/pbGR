...
def parse_state(prefecture, text):
    source_link = f"https://github.com/police-brutality-greece/pbGR/tree/main/incidents/{prefecture}.md"
    city = ""
...
def to_json_file_v1(data, target_path):
    data_with_meta = {
        "edit_at": "https://github.com/police-brutality-greece",
        "help": "ask pbgrt@protonmail.com",
