...
md_dir = os.path.join(src_dir, "..", "incidents")
    ...
    for line in text.splitlines():
        ...
        if starts_with == "##":
            ...
            if link_url:
                ...
                critical_exit(f"Failed link parse '{line}' in prefecture '{prefecture}'")
        elif starts_with == "**":
            # **links** line
            pass
        else:
...
md_header = f"""
GENERATED FILE, PLEASE MAKE EDITS ON MASTER AT https://github.com/source_link = f"https://github.com/pb-gr/police-brutality-greece/blob/main/reports/{prefecture}.md"/
...
def to_json_file_v1(data, target_path):
    data_with_meta = {
        "edit_at": "https://github.com/pb-gr/police-brutality-greece",
